...
const Homecustomer = () => {
    // Khởi tạo state để lưu trữ giá trị của các trường form
    ...
    // State để quản lý thông báo gửi thành công/thất bại
                                        ...
                                        <form onSubmit={handleSubmit}>
                                            <div className="form-group">
                                                ...
                                                <input
                                                    ...
                                                    id="name"
                                                    name="name"
                                                    value={formData.name} // Gắn giá trị từ state
                                            ...
                                            <div className="form-group">
                                                ...
                                                <input
                                                    ...
                                                    id="phone"
                                                    name="phone"
                                                    value={formData.phone} // Gắn giá trị từ state
                                                    onChange={handleChange} // Gắn hàm xử lý thay đổi
                                                    required
                                                />
                                            </div>
                                            ...
                                            <div className="form-group">
                                                ...
                                                <textarea
                                                    id="message"
                                                    name="message"
                                                    value={formData.message} // Gắn giá trị từ state
                                                    onChange={handleChange} // Gắn hàm xử lý thay đổi
                                                    required
                                                ></textarea>
                                            </div>

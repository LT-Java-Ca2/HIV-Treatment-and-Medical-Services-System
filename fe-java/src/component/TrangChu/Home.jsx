...
const Home = () => {
    // 1. Khởi tạo state để lưu trữ giá trị của các trường form
        ...
        <>
            <nav className="navbar">
                ...
                <ul className="nav-links">
                    {/* Changed Link to a for internal page navigation */}
                    <li><a href="#home">Trang chủ</a></li>
                    <li><a href="#about">Giới thiệu</a></li>
                    <li><a href="#blog">Tài liệu & Blog</a></li>
            ...
            <section id="home" className="hero">
                <div className="hero-content">
                    ...
                    <Link to="/register" className="btn-primary">More Info</Link>
                </div>
            </section>
